...
public class FlyingItemManager {
    ...
    public void spawn(DoremonHandler doremonHandler, Item itemTriggered, Entity target) {
        ...
        for (int i = 0; i < flyingItemArrayList.size(); i++) {
            ...
            if (!flyingItem.isAlive()) {
                ...
                flyingItemArrayList.add(FlyingItem.create(doremonHandler, itemTriggered, target));
