...
public class Play extends com.game.Controller.GameState {

    private com.game.Controller.Slider slider;
...
//        case1IMG.setY((float) (screenHight * 0.006));
    ...
    public void update(float dt) {
        ...
        if (nd) {
            ...
            stage.clear();
            com.game.Controller.Music.play("gameover");
            if (HighScore > com.game.Controller.HightScoreData.getScoreData()) {
...
//get content of label case
    ...
    public void answareCase1() {
        ...
        if(trueLT.equalsIgnoreCase(caseLT1.trim())){
            ...
            com.game.Controller.Music.play("point");
            getContent();
        }else{
            slider=null;
            nd=false;
